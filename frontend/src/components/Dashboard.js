    ...
    useEffect(() => {
        ...
        axios.get('/api/calories/user/:userId', {
            ...
            .then(response => {
                ...
                const total = calorieData.reduce((acc, entry) => acc + entry.calories, 0);
        ...
        axios.get('/api/exercise/user/:userId', {
            ...
            .then(response => {
                ...
                const total = exerciseData.reduce((acc, entry) => acc + entry.duration, 0);
        ...
        axios.get('/api/sleep/user/:userId', {
            ...
            .then(response => {
                ...
                const total = sleepData.reduce((acc, entry) => acc + entry.sleep_duration, 0);
